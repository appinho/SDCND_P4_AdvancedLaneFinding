...
axarr[0,1].set_title('Sobel x', fontsize=50)
axarr[0,2].imshow(grady, cmap='gray')
axarr[0,2].set_title('Sobel y', fontsize=50)
axarr[0,3].imshow(combined_sobel, cmap='gray')
axarr[0,3].set_title('Combined sobel', fontsize=50)
axarr[1,0].imshow(combined, cmap='gray')
axarr[1,0].set_title('Result', fontsize=50)
axarr[1,1].imshow(mag_binary, cmap='gray')
axarr[1,1].set_title('Magnitude', fontsize=50)
axarr[1,2].imshow(dir_binary, cmap='gray')
axarr[1,2].set_title('Direction', fontsize=50)
axarr[1,3].imshow(combined_gradient, cmap='gray')
axarr[1,3].set_title('Combined gradient', fontsize=50)
